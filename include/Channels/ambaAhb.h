...
public:
    ...
    AmbaAhbBusSlaveMacLinkPass()
         :sc_core::sc_module(sc_core::sc_gen_unique_name("AmbaAhbBusSlaveMacLinkPass")) {}   
...
public:
    sc_core::sc_port<IAmbaAhbBusSlaveMacTlmProt > protWMac;
     ...
     AmbaAhbBusSlaveMacMemPass()
         :sc_core::sc_module(sc_core::sc_gen_unique_name("AmbaAhbBusSlaveMacMemPass")) {}
...
public:
    ...
    AmbaAhbBusMasterMacLinkPass()
         :sc_core::sc_module(sc_core::sc_gen_unique_name("AmbaAhbBusMasterMacLinkPass")) {}
...
public:
    ...
    AmbaAhbBusMasterMacMemPass()
        :sc_core::sc_module(sc_core::sc_gen_unique_name("AmbaAhbBusMasterMacMemPass")) {}
